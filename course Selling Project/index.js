...
const adminAuthentication = (req, res, next) => {
    ...
    if (admin) {
        ...
        res.status(403).json({ message: 'Admin authenticatiion failed' });
    }
};
...
const userAuthentication = (req, res, next) => {
    ...
    if (user) {
        ...
        res.status(403).json({ message: 'User authenticatiion failed' });
    }
};
...
app.post('/users/courses/:courseId', userAuthentication, (req, res) => {
    ...
    if (course) {
        ...
        res.json({ meassage: 'Course purchased successfully' })
    } else {
